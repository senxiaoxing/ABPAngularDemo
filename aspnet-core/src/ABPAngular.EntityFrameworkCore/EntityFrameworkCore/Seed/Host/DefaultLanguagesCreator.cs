...
namespace ABPAngular.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly ABPAngularDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = ABPAngularConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
            return new List<ApplicationLanguage>
            {
                ...
                new ApplicationLanguage(tenantId, "zh-Hans-HK", "繁體中文", "famfamfam-flags hk"),
        ...
        public DefaultLanguagesCreator(ABPAngularDbContext context)
        {
            _context = context;
        }
